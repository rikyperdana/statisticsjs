...
variation(stanDev(variance(data)), mean(data))
variation(stanDev(distVariance(distFreq(data))), distMean(data))
variation(range(data), mean(data))
variation(distRange(distFreq(data)), distMean(data))
variation(iQR(data), median(data))
variation(distIQR(distFreq(data)), distMedian(distFreq(data)))
```
hal.68
